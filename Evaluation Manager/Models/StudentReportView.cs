...
namespace Evaluation_Manager.Models
{
    public class StudentReportView
    {
        ...
        public StudentReportView(Student student)
        {
            ...
            //e je element u list. vrati e za koji vrijedi da je naziv aktivnosti zadaca 3(to je filtriranje po listi)
            //FirstOrDefault vratit ce prvi element iz liste za koji to vrijedi, ako ne nade onda je NULL i treba nadopunit kod
